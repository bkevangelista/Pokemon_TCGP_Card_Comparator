...
@router.get(f"{tcgBaseEndpoint}/compareCardsForUsers")
async def compareCardsForUsers(
        user1: str,
        user2: str,
        set_id: str,
    ...
    cards = await user_card_service.compareCardsForUsers(user1, user2, set_id, cards_in_set)
    return {
